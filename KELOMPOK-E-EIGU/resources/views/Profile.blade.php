                            ...
                            <div class="row mb-3">
                                <div class="col" style="padding-top: 80px">
                                    ...
                                    @if ($integration->dribbble != 'None')
                                        <a href="https://dribbble.com/{{ $integration->dribbble }}" target="_blank" class="btn bg-abu round">+ Add Account</a>
                                    @endif
                                    @if ($integration->behance != 'None')
                                    <a href="https://www.behance.net/{{ $integration->behance }}" target="_blank" class="btn bg-abu round">+ Add Account</a>
                                @endif
